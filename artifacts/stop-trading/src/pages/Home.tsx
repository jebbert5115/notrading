  ...
  return (
    <div className="min-h-screen rustic-bg text-white relative">
      <div className="relative z-10 max-w-3xl mx-auto px-6 py-14 md:py-20">
        ...
        <h1 className="text-5xl md:text-7xl font-black leading-none mb-6 tracking-tight worn-text">
          You Cannot<br />
        ...
        <div className="space-y-8 text-[#bfbfbf] text-lg leading-relaxed">
          ...
          <p className="text-2xl text-white font-semibold worn-text">
            Trading is <span style={{ color: '#e01515' }} className="font-black">not allowed</span> in this server.
        ...
        <div className="mt-12 pt-8 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between" style={{ borderTop: '1px solid rgba(120,40,30,0.2)' }}>
          ...
          <a
            ...
            onMouseEnter={e => { (e.currentTarget as HTMLElement).style.color = '#fff'; (e.currentTarget as HTMLElement).style.borderColor = '#c81e1e'; }}
            onMouseLeave={e => { (e.currentTarget as HTMLElement).style.color = '#e01515'; (e.currentTarget as HTMLElement).style.borderColor = 'rgba(200,30,30,0.3)'; }}
          >
            View Wall of Shame →
          </a>
        </div>
